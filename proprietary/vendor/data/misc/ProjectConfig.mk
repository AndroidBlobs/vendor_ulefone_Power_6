...
CUSTOM_HAL_IMGSENSOR = imx298_mipi_raw imx298new_mipi_raw s5k3p3sp_mipi_raw s5k3p3sx_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_LENS = fp5510e2af fp5510e2afnew dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = imx298_mipi_raw imx298new_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_MAIN_LENS = fp5510e2af fp5510e2afnew
CUSTOM_HAL_MSENSORLIB = akl akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS =
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p3sp_mipi_raw s5k3p3sx_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx298_mipi_raw imx298new_mipi_raw s5k3p3sp_mipi_raw s5k3p3sx_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = fp5510e2af fp5510e2afnew dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS =
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx298_mipi_raw imx298new_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_MAIN_LENS = fp5510e2af fp5510e2afnew
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p3sp_mipi_raw s5k3p3sx_mipi_raw
...
CUSTOM_MODEM=m860_TK_MD_BASIC-LWTG_R3_6765-fdd4m_gsm4_w12458_tdd40_fdd12345781217181920252666_tiaoxie_airoha_cotsx
...
#switch for mmi
CUSTOM_BUILD_VERNO = GQ3081SF1_M860B1_Ulefone_20190921_V07
MTK_BUILD_VERNO = Power_6_SF1_V01

HCT_BUILD_PRODUCT_NAME = m860D-GQ-GQ3081-cobom-63-512g32g-fhdp-bom5-p0-cts-notEu

HCT_LOCALIZATION_OVERLAY = zh-rCN
HCT_PRODUCT_TIMEZONE = Europe/London

#指纹
HCT_SUPPORT_FINGERPRINT =yes
HCT_SUPPORT_FINGERPRINT_CHIP=sunwave_tee
HCT_SUNWAVE_FINGERPRINT_SPI0=yes
HCT_TEE_FINGER_TYPE=Trustkernel

#品牌、型号、制造商
HCT_PRODUCT_NAME = Power_6
HCT_PRODUCT_MODEL = Power_6
HCT_PRODUCT_BRAND = Ulefone
HCT_PRODUCT_MANUFACTURER = Ulefone

#屏密度、导航栏
HCT_LCD_RESOULTION_SIZE = FHDP
HCT_DISPLAY_NAV_BAR = yes
HCT_NAVIGATION_BAR_STYLE = yes

#上划手势
HCT_SWIPE_UP_GESTURE=no

#计步器
HCT_STEP_RECORD_SUPPORT=yes

#开机动画
HCT_BOOTANIM = yes

# mada
HCT_GOOGLE_CLIENTIDBASE = android-gotron

#人脸识别
FACE_UNLOCK_SUPPORT = yes

# 扫一扫
HCT_QR_CODE_SCAN = yes
#去除桌面扫一扫图标
HCT_QR_CODE_SCAN_NOICON = yes

#多功能截图,长截图
HCT_LONG_SCREEN_SHOT_SUPPORT = yes
HCT_SUPPORT_SCREEN_SHOT = yes

# 一键清理
HCT_CLEAN_ONEKEY = yes

# 深度清理
HCT_CLEAN_MEMORY_DEEP = yes

# 后台自动清理
HCT_BACKGROUND_CLEAN_MEMORY = yes

# 智能体感
HCT_MULTI_FINGER_GESTURE_SUPPORT = yes

# 自启动管理
HCT_AUTOSTART_MANAGER = yes

# 系统管家
HCT_SUPPORT_SYSTEM_MANAGER = yes

#屏幕录制
HCT_SUPPORT_SCREENRECORD = yes

#视频
HCT_SUPPORT_VIDEOPLAYER = yes

#刘海屏feature
HCT_SUPPORT_NOTCH_SCREEN = yes

#Recovery刘海屏适配
HCT_NOTCH_SCREEN_RECOVERY_SUPPORT=yes
#Factory刘海屏适配
HCT_NOTCH_SCREEN_FACTORY_SUPPORT=yes

#单屏壁纸
HCT_SINGELSCREEN_WALLPAPER = yes
#护眼模式
HCT_SUPPORT_EYE_PROTECTION = yes
#客需默认网址
HCT_CHROME_HOMEPAGE_CUSTOMIZE = yes
#数据连接默认关闭
HCT_MOBILE_DATA_DEFAULT_OFF = yes
#记事本
HCT_SUPPORT_NOTES = yes
#工具箱
HCT_TOOLBAG_SUPPORT = yes
#智能唤醒
HCT_SUPPORT_GESTUREWAKE = yes
#抬腕亮屏
HCT_SUPPORT_RAISE_WRIST_WAKEUP = yes
#紧急呼救
HCT_HCTSOS_SUPPORT = yes
HCT_VOLUME_DOWN_SOS_SUPPORT = yes

#儿童模式
HCT_CHLIDMODE_SUPPORT = yes

#定制化状态栏
HCT_STATUSBAR_STYLE_SUPPORT = yes

#相机
HCT_CAMERA2_SUPPORT = yes
#虚化,设计hall层,还需在 AUTO_ADD_GLOBAL_DEFINE_BY_NAME 后定义
...
#锁定 fingerprint
HCT_VERSION_INCREMENTAL = 1558318996
...
#快速通道fastpass
HCT_FASTPASS_SUPPORT = yes

#cts
MTK_2SDCARD_SWAP = no
MTK_OWNER_SDCARD_ONLY_SUPPORT = yes
HCT_MODIFY_FOR_CTS = yes
MTK_SIGNATURE_CUSTOMIZATION = yes
HCT_GOOGLE_GMS_R6 = yes
MTK_FW_UPGRADE = no
HCT_PACKAGES_SUBSTITUTE = Baidu_Location:- DeskClockGoogle:- GoogleContacts:- GoogleDialer:- TagGoogle:- Keep:- CalculatorGoogle:- OobConfig:- GmsSampleIntegration:- FaceLock:- SearchLauncherQuickStep:- GmsEEAType4cIntegration:-
MTK_ATF_SUPPORT=yes
MTK_TEE_SUPPORT=yes
